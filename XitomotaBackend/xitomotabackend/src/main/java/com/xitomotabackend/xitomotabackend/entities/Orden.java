...
@Entity
@Table(name = "ordenes") // Nombre de la tabla
public class Orden {
    ...
    private int total; // El total pagado
    ...
    // --- Getters y Setters ---
    // (Asegúrate de generar Getters y Setters para TODOS los campos)
    // id, nombre, apellidos, correo, calle, departamento, etc...
