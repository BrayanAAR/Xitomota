...
const listadeCamisas = [
  {
    id: 1,
    nombre: 'Camisa Básica Algodón',
    precio: 12990,
    imagen: fotoCamisas,
  },
  {
    id: 2,
    nombre: 'Camisa Estampado Gráfico',
    precio: 15990,
    imagen: fotoCamisas,
  },
  {
  ...
  {
    id: 4,
    nombre: 'Camisa Deportiva Transpirable',
    precio: 19990,
    imagen: fotoCamisas,
  },
];
  ...
  return (
    <>
        ...
        <div className="productos-lista">
          {listadeCamisas.map((camisa) => (
            <div key={camisa.id} className="producto-item">
              <img src={camisa.imagen} alt={camisa.nombre} />
