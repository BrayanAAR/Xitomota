...
const listadePolerones = [
  {
    id: 1,
    nombre: 'Poleron Básica Algodón',
    precio: 12990,
    imagen: fotoPolerones,
  },
  {
    id: 2,
    nombre: 'Poleron Estampado Gráfico',
    precio: 15990,
    imagen: fotoPolerones,
  },
  {
    id: 3,
    nombre: 'Poleron Manga Larga',
    precio: 17990,
    imagen: fotoPolerones,
  },
  {
    id: 4,
    nombre: 'Poleron Deportivo Transpirable',
    precio: 19990,
    imagen: fotoPolerones,
  },
];
  ...
  return (
    <>
        ...
        <div className="productos-lista">
          {listadePolerones.map((poleron) => (
            <div key={poleron.id} className="producto-item">
              <img src={poleron.imagen} alt={poleron.nombre} />
